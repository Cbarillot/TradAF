% IMPORTANT: This document requires the tradaf.sty package file
% which must be in the same directory as this .tex file.
% If compiling on Overleaf, ensure tradaf.sty is uploaded to your project.
% The tradaf.sty file is included in this repository.

\documentclass[12pt,a4paper]{article}
\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
\usepackage[french]{babel}
\usepackage{tradaf}  % Custom package - requires tradaf.sty in same directory
\usepackage{hyperref}
